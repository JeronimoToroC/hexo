...
export const trimBody = (body: () => any) => {
...
const testTrimBody = () => {
  // Caso 1: Cadena con saltos de línea al principio y al final
  const case1 = '\nHello World\n\n';
  console.log(
    'Caso 1:',
    trimBody(() => case1),
  ...
  // Caso 2: Cadena con múltiples saltos de línea al principio y al final
  const case2 = '\n\n\nMultiple\nNewlines\n\n\n';
  console.log(
    'Caso 2:',
    trimBody(() => case2),
  ); // Debería ser 'Multiple\nNewlines'

  // Caso 3: Cadena sin saltos de línea
  const case3 = 'NoNewlinesHere';
  console.log(
    'Caso 3:',
    trimBody(() => case3),
  ); // Debería ser 'NoNewlinesHere'
